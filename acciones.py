...
# Carga la base de conocimientos desde "base_conocimiento" al iniciar base_conocimiento.json
try: 
    engine.base.from_json("base_conocimiento.json")
    print("Base de conocimientos 'base_conocimiento.json' cargada exitosamente.")
