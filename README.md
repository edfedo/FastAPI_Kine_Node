...
[-] Se adjunta link de descarga de los codecs para windows (ruta interna dentro del mismo Git - Sigue el link y click View raw, esto descargara los codecs en formato zip, descomprimir e instalar)
